...
# GTEA pretrained model
# default_run = 'GTEA'
default_run = 'GTEA_ooi'
...
def main(_):
    ...
    threshold = 0.5
    object_prediction = output_image >= threshold
    """
    for row in object_prediction:
      for col in row:
        if col == True:
            print(col)
    """
    ...
    green_image = tv_utils.fast_overlay(image, object_prediction)
    ...
    logging.info("Red plot of predictions have been saved to: {}".format(
